/**
 * Contains methods to work with timezones
 */
export default class Timezones {

    static timezones: Map<string, string> = new Map([
    ...
    /**
     * Returns a short name for a timezone
     * @param {string} name Long name for a timezone
     * @return {string | null}
     */
    static shortName(name: string): string | null {
        const timezone = Timezones.timezones.get(name);
