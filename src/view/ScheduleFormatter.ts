...
export default class ScheduleFormatter {
    ...
    protected static formatSchedule(locale: string, schedule: Schedule, part: string = 'full_long'): string {
        ...
        switch (part) {
            case 'start_long': return DateTimeFormatter.format(locale, schedule.start, withTime);
            case 'start_short': return DateTimeFormatter.format(locale, schedule.start);
            case 'end_long': return DateTimeFormatter.format(locale, schedule.end, withTime);
            case 'end_short': return DateTimeFormatter.format(locale, schedule.end);
            case 'timezone_long':
            ...
            case 'timezone_short':
                return schedule.timezone ?
                    ...
                    '';
            case 'full_short': return ScheduleFormatter.formatFullDate(locale, schedule);
            case 'full_long':
